...
const gamePanel = [
    {
        ...
        thumbnails: [
            ...
            "../paneljuego/img/sh4_4.jpg",
            "../paneljuego/img/sh4_5.jpg",
            "../paneljuego/img/sh4_6.jpg"
        ],
        posterImage: "../../paneljuego/img/sh4cover.png"
    },
    {
        id: "2",
        title: "NieR:Automata™",
        description: "NieR: Automata narra la historia de los androides 2B, 9S y A2, que luchan para recuperar el mundo distópico dirigido por las máquinas que han invadido unas poderosas formas de vida mecánicas.",
        modelviewer:"../../paneljuego/models/nier_case.glb",
        thumbnails: [
        ...
        posterImage: "../../paneljuego/img/niercover.png"
    },
    {
        id: "3",
